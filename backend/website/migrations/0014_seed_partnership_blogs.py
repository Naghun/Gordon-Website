...
def seed_blogs(apps, schema_editor):
    ...
    posts = [
        {
            'title': 'GordonDM i Binance potpisali ugovor o saradnji',
            'slug': 'gordondm-binance-saradnja',
            ...
            'category': 'crypto', 'cover_logo': 'binance', 'is_featured': True,
        },
        {
            'title': 'GordonDM i Solana potpisali ugovor o saradnji',
            'slug': 'gordondm-solana-saradnja',
            ...
            'category': 'crypto', 'cover_logo': 'solana', 'is_featured': True,
        },
    ]
    for post in posts:
...
def remove_seed_blogs(apps, schema_editor):
    apps.get_model('website', 'BlogPost').objects.filter(slug__in=['gordondm-binance-saradnja','gordondm-solana-saradnja']).delete()


class Migration(migrations.Migration):

    dependencies = [
        ('website', '0013_blogpost'),
    ]

    operations = [
        migrations.RunPython(seed_blogs, remove_seed_blogs),
    ]
